...
from transformers import AutoTokenizer, get_linear_schedule_with_warmup, DistilBertTokenizerFast
...
def parse_args():
    ...
    ap.add_argument("--batch_size", type=int, default=16) # Increased batch size
    ap.add_argument("--epochs", type=int, default=5)      # Increased epochs
    ap.add_argument("--lr", type=float, default=5e-5)
    ap.add_argument("--max_length", type=int, default=128) # Reduced max_length for speed
